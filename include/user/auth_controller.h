...
public:
    ...
    virtual crow::response Register(const crow::request& request) = 0;
    ...
    virtual crow::response Login(const crow::request& request) = 0;
    ...
    virtual crow::response Logout(const crow::request& request) = 0;
};
